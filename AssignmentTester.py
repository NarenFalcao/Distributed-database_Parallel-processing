...
if __name__ == '__main__':
    try:
        ...
        with getopenconnection(dbname=DATABASE_NAME) as conn:
            ...
            testroundrobininsert(RATINGS_TABLE, 99, 2, 0, conn, RROBIN_TABLE_PREFIX + '4')
            testroundrobininsert(RATINGS_TABLE, 101, 2, 0, conn, RROBIN_TABLE_PREFIX + '0')
            testroundrobininsert(RATINGS_TABLE, 102, 3, 5, conn, RROBIN_TABLE_PREFIX + '1')
            testroundrobininsert(RATINGS_TABLE, 103, 4, 1.5, conn, RROBIN_TABLE_PREFIX + '2')
            testroundrobininsert(RATINGS_TABLE, 104, 5, 3.5, conn, RROBIN_TABLE_PREFIX + '3')
            testroundrobininsert(RATINGS_TABLE, 105, 6, 2.5, conn, RROBIN_TABLE_PREFIX + '4')


            testrangeinsert(RATINGS_TABLE, 107, 2, 0, conn, RANGE_TABLE_PREFIX + '0')
            testrangeinsert(RATINGS_TABLE, 1007, 2, 1, conn, RANGE_TABLE_PREFIX + '0')
            testrangeinsert(RATINGS_TABLE, 1001, 2, 1.5, conn, RANGE_TABLE_PREFIX + '1')
            testrangeinsert(RATINGS_TABLE, 1002, 2, 2, conn, RANGE_TABLE_PREFIX + '1')
            testrangeinsert(RATINGS_TABLE, 1003, 2, 2.5, conn, RANGE_TABLE_PREFIX + '2')
            testrangeinsert(RATINGS_TABLE, 1004, 2, 3, conn, RANGE_TABLE_PREFIX + '2')
            testrangeinsert(RATINGS_TABLE, 1005, 2, 3.5, conn, RANGE_TABLE_PREFIX + '3')
            testrangeinsert(RATINGS_TABLE, 1006, 2, 4, conn, RANGE_TABLE_PREFIX + '3')
            testrangeinsert(RATINGS_TABLE, 1007, 2, 4.5, conn, RANGE_TABLE_PREFIX + '4')
            testrangeinsert(RATINGS_TABLE, 1008, 2, 5, conn, RANGE_TABLE_PREFIX + '4')
